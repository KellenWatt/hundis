...
Problem.create!(name: 'Test_problem_1', score: 1, description: 'stuff', path: 'some path')
Problem.create!(name: 'Test_problem_2', score: 1, description: 'stuff and', path: 'some path')
Problem.create!(name: 'Test_problem_3', score: 1, description: 'stuff and things', path: 'some path')
Problem.create!(name: 'Test_problem_4', score: 1, description: 'stuff and thing like', path: 'some path')
Problem.create!(name: 'Test_problem_5', score: 1, description: 'stuff and things like that', path: 'some path')
Problem.create!(name: 'Test_problem_6', score: 1, description: 'stuff and things like that for', path: 'some path')
Problem.create!(name: 'Test_problem_7', score: 1, description: 'stuff and things like that for all', path: 'some path')
Problem.create!(name: 'Test_problem_8', score: 1, description: 'stuff and things like that for all people', path: 'some path')
Problem.create!(name: 'Test_problem_9', score: 1, description: 'stuff and things like that for all people on', path: 'some path')
Problem.create!(name: 'Test_problem_10', score: 1, description: 'stuff and things like that for all people on Earth', path: 'some path')
